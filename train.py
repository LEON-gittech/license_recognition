...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Directories
    wdir = save_dir / 'weights' ###################储存在runs/train中
    wdir.mkdir(parents=True, exist_ok=True)  # make dir
    last = wdir / 'last.pt'
    best = wdir / 'best.pt'
    results_file = save_dir / 'results.txt'

    # Save run settings都是在存储训练过程的结果
    ...
    # Logging- Doing this before checking the dataset. Might update data_dict，这步可太有用了！！！！！！！！！！我都不知道yaml是个啥东西
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--allow_val_change', action='store_true', help='allow_val_change change value of key "opt"')
